 ...
 * pcl.js - v1.16.0
 *
 * Copyright (c) 2023 pcl.js Authors
...
class PointXYZ {
    constructor(x = 0, y = 0, z = 0) {
        ...
        this.y = y;
        this.z = z;
        this._PointXYZ = 'PointXYZ';
    }
}
class PointXYZI {
    constructor(x = 0, y = 0, z = 0, intensity = 0) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.intensity = intensity;
        this._PointXYZI = 'PointXYZI';
    }
}
class PointXYZL {
    constructor(x = 0, y = 0, z = 0, label = 0) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.label = label;
        this._PointXYZL = 'PointXYZL';
    }
}
class InterestPoint {
    constructor(x = 0, y = 0, z = 0, strength = 0) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.strength = strength;
        this._InterestPoint = 'InterestPoint';
    }
}
class PointXYZRGB {
    constructor(x = 0, y = 0, z = 0, r = 0, g = 0, b = 0) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.r = r;
        this.g = g;
        this.b = b;
        this._PointXYZRGB = 'PointXYZRGB';
    }
}
class PointXYZRGBA {
    constructor(x = 0, y = 0, z = 0, r = 0, g = 0, b = 0, a = 0) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.r = r;
        ...
        this.b = b;
        this.a = a;
        this._PointXYZRGBA = 'PointXYZRGBA';
    }
}
class PointXYZRGBL {
    constructor(x = 0, y = 0, z = 0, r = 0, g = 0, b = 0, label = 0) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.r = r;
        ...
        this.b = b;
        this.label = label;
        this._PointXYZRGBL = 'PointXYZRGBL';
    }
}
class Normal {
    constructor(normalX = 0, normalY = 0, normalZ = 0, curvature = 0) {
...
class PointNormal {
    constructor(x = 0, y = 0, z = 0, normalX = 0, normalY = 0, normalZ = 0, curvature = 0) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.normalX = normalX;
        ...
        this.normalZ = normalZ;
        this.curvature = curvature;
        this._PointNormal = 'PointNormal';
    }
}
class PointXYZLNormal {
    constructor(x = 0, y = 0, z = 0, label = 0, normalX = 0, normalY = 0, normalZ = 0, curvature = 0) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.label = label;
        ...
        this.normalZ = normalZ;
        this.curvature = curvature;
        this._PointXYZLNormal = 'PointXYZLNormal';
    }
}
class PointXYZINormal {
    constructor(x = 0, y = 0, z = 0, intensity = 0, normalX = 0, normalY = 0, normalZ = 0, curvature = 0) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.intensity = intensity;
        ...
        this.normalZ = normalZ;
        this.curvature = curvature;
        this._PointXYZINormal = 'PointXYZINormal';
    }
}
class PointXYZRGBNormal {
    constructor(x = 0, y = 0, z = 0, r = 0, g = 0, b = 0, normalX = 0, normalY = 0, normalZ = 0, curvature = 0) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.r = r;
        ...
        this.normalZ = normalZ;
        this.curvature = curvature;
        this._PointXYZRGBNormal = 'PointXYZRGBNormal';
    }
}
class PointSurfel {
    constructor(x = 0, y = 0, z = 0, normalX = 0, normalY = 0, normalZ = 0, r = 0, g = 0, b = 0, a = 0, radius = 0, confidence = 0, curvature = 0) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.normalX = normalX;
        ...
        this.curvature = curvature;
        this._PointSurfel = 'PointSurfel';
    }
}
class FPFHSignature33 {
    constructor(histogram) {
        this._native = new __PCLCore__.FPFHSignature33();
        if (histogram) {
...
FPFHSignature33.descriptorSize = 33;
const pointTypeMap = {
    PointXY,
    PointXYZ,
    PointXYZI,
...
function getPointType(native, className) {
    const name = native.$$.ptrType.registeredClass.name.replace(className, '');
    return pointTypeMap[name];
}

// pcl.js version
const VERSION = '1.16.0';
// Point Cloud Library (PCL) version
const PCL_VERSION = '1.13.0';

/**
 * https://github.com/emscripten-core/emscripten/blob/main/src/library_fs.js
 * https://nodejs.org/api/fs.html#file-system
 */
const writeFile = (path, data, opts) => __PCLCore__.FS.writeFile(path, data, opts);
function readFile(path, opts) {
    return __PCLCore__.FS.readFile(path, opts);
}
const unlink = (path) => __PCLCore__.FS.unlink(path);
const rename = (oldPath, newPath) => __PCLCore__.FS.rename(oldPath, newPath);
const mkdir = (path, mode) => __PCLCore__.FS.mkdir(path, mode);
const rmdir = (path) => __PCLCore__.FS.rmdir(path);
const readdir = (path) => __PCLCore__.FS.readdir(path);
function stat(path, dontFollow) {
    const { FS } = __PCLCore__;
    const info = FS.stat(path, dontFollow);
    return Object.assign(Object.assign({}, info), { isDir: FS.isDir(info.mode), isFile: FS.isFile(info.mode) });
}
...
class Vector {
    ...
    resize(count, value) {
        this._native.resize(count, value !== null && value !== void 0 ? value : null);
    }
    clear() {
        this._native.clear();
    }
}
class Indices extends Vector {
    constructor(native) {
        const _native = native !== null && native !== void 0 ? native : new __PCLCore__.Indices();
        super(_native);
    }
}
class PCLHeader {
...
class Points extends Vector {
    ...
    get(index) {
        ...
        if (value instanceof __PCLCore__.FPFHSignature33) {
            return new PT(Array.from(value.getHistogram()));
        }
        else {
...
class PointCloud {
    constructor(_PT = PointXYZ, _native) {
        this._PT = _PT;
        this._native = _native !== null && _native !== void 0 ? _native : new __PCLCore__[`PointCloud${_PT.name}`]();
        this.manager = new Manager(this._native);
    }
    get isOrganized() {
     ...
     */
    resize(count, pt) {
        this._native.resize(count, pt !== null && pt !== void 0 ? pt : new this._PT());
    }
    /**
...
function wrapPointCloud(_native) {
    return new PointCloud(getPointType(_native, 'PointCloud'), _native);
}
function wrapPoints(_native) {
    return new Points(_native);
}
...
function readPCDHeader(buffer) {
    ...
    // evaluate
    if (version !== null)
        PCDHeader.version = parseFloat(version[1]);
    if (fields !== null)
        PCDHeader.fields = fields[1].split(' ');
    if (type !== null)
        PCDHeader.type = type[1].split(' ');
    if (width !== null)
        PCDHeader.width = parseInt(width[1]);
    if (height !== null)
        PCDHeader.height = parseInt(height[1]);
    if (viewpoint !== null)
...
function loadPCDFile(filename, _PT = PointXYZ) {
    const cloud = new PointCloud(_PT);
...
function savePCDDataASCII(cloud) {
    return savePCDData(cloud);
}
function savePCDDataBinary(cloud) {
    return savePCDData(cloud, true);
}
function savePCDDataBinaryCompressed(cloud) {
    const filename = `temp-${getRandomArbitrary(0, 10000)}.pcd`;
...
var SacMethodTypes;
(function (SacMethodTypes) {
    SacMethodTypes[SacMethodTypes["SAC_RANSAC"] = 0] = "SAC_RANSAC";
    SacMethodTypes[SacMethodTypes["SAC_LMEDS"] = 1] = "SAC_LMEDS";
    SacMethodTypes[SacMethodTypes["SAC_MSAC"] = 2] = "SAC_MSAC";
    SacMethodTypes[SacMethodTypes["SAC_RRANSAC"] = 3] = "SAC_RRANSAC";
    SacMethodTypes[SacMethodTypes["SAC_RMSAC"] = 4] = "SAC_RMSAC";
    SacMethodTypes[SacMethodTypes["SAC_MLESAC"] = 5] = "SAC_MLESAC";
    SacMethodTypes[SacMethodTypes["SAC_PROSAC"] = 6] = "SAC_PROSAC";
})(SacMethodTypes || (SacMethodTypes = {}));
var SacModelTypes;
(function (SacModelTypes) {
    SacModelTypes[SacModelTypes["SACMODEL_PLANE"] = 0] = "SACMODEL_PLANE";
    SacModelTypes[SacModelTypes["SACMODEL_LINE"] = 1] = "SACMODEL_LINE";
    SacModelTypes[SacModelTypes["SACMODEL_CIRCLE2D"] = 2] = "SACMODEL_CIRCLE2D";
    SacModelTypes[SacModelTypes["SACMODEL_CIRCLE3D"] = 3] = "SACMODEL_CIRCLE3D";
    SacModelTypes[SacModelTypes["SACMODEL_SPHERE"] = 4] = "SACMODEL_SPHERE";
    SacModelTypes[SacModelTypes["SACMODEL_CYLINDER"] = 5] = "SACMODEL_CYLINDER";
    SacModelTypes[SacModelTypes["SACMODEL_CONE"] = 6] = "SACMODEL_CONE";
    SacModelTypes[SacModelTypes["SACMODEL_TORUS"] = 7] = "SACMODEL_TORUS";
    SacModelTypes[SacModelTypes["SACMODEL_PARALLEL_LINE"] = 8] = "SACMODEL_PARALLEL_LINE";
    SacModelTypes[SacModelTypes["SACMODEL_PERPENDICULAR_PLANE"] = 9] = "SACMODEL_PERPENDICULAR_PLANE";
    SacModelTypes[SacModelTypes["SACMODEL_PARALLEL_LINES"] = 10] = "SACMODEL_PARALLEL_LINES";
    SacModelTypes[SacModelTypes["SACMODEL_NORMAL_PLANE"] = 11] = "SACMODEL_NORMAL_PLANE";
    SacModelTypes[SacModelTypes["SACMODEL_NORMAL_SPHERE"] = 12] = "SACMODEL_NORMAL_SPHERE";
    SacModelTypes[SacModelTypes["SACMODEL_REGISTRATION"] = 13] = "SACMODEL_REGISTRATION";
    SacModelTypes[SacModelTypes["SACMODEL_REGISTRATION_2D"] = 14] = "SACMODEL_REGISTRATION_2D";
    SacModelTypes[SacModelTypes["SACMODEL_PARALLEL_PLANE"] = 15] = "SACMODEL_PARALLEL_PLANE";
    SacModelTypes[SacModelTypes["SACMODEL_NORMAL_PARALLEL_PLANE"] = 16] = "SACMODEL_NORMAL_PARALLEL_PLANE";
    SacModelTypes[SacModelTypes["SACMODEL_STICK"] = 17] = "SACMODEL_STICK";
})(SacModelTypes || (SacModelTypes = {}));
...
class KdTree$1 {
    ...
    getInputCloud() {
        return wrapPointCloud(this._native.getInputCloud());
    }
}

class KdTreeFLANN extends KdTree$1 {
    constructor(_PT = PointXYZ, sorted = true) {
    ...
    nearestKSearch(point, k) {
        ...
        const distances = new Vector(new __PCLCore__.VectorFloat());
    ...
    radiusSearch(point, radius, maxNN = 0) {
        const indices = new Indices();
        const distances = new Vector(new __PCLCore__.VectorFloat());
...
class FilterBase extends PCLBase {
    filter(cloud) {
        if (!this._PT) {
            return null;
        }
        const _cloud = cloud !== null && cloud !== void 0 ? cloud : new PointCloud(this._PT);
...
class PassThrough extends FilterIndices {
    constructor(_PT = PointXYZ, extractRemovedIndices = false) {
    ...
    getFilterFieldName() {
        return this._native.getFilterFieldName();
    }
...
class VoxelGrid extends FilterBase {
    ...
    setDownsampleAllData(downsample) {
...
class RadiusOutlierRemoval extends FilterIndices {
    ...
    setMinNeighborsInRadius(minPts = 1) {
...
class UniformSampling extends FilterBase {
    constructor(_PT = PointXYZ, extractRemovedIndices = false) {
...
class RandomSample extends FilterIndices {
    constructor(_PT = PointXYZ, extractRemovedIndices = false) {
...
class GridMinimum extends FilterIndices {
    constructor(_PT = PointXYZ, resolution = 0) {
...
class LocalMaximum extends FilterIndices {
    constructor(_PT = PointXYZ, extractRemovedIndices = false) {
...
class ApproximateVoxelGrid extends FilterBase {
    constructor(_PT = PointXYZ) {
...
function removeNaNFromPointCloud(cloudIn, cloudOut, indices) {
    const _cloudOut = cloudOut !== null && cloudOut !== void 0 ? cloudOut : new PointCloud(cloudIn._PT);
    const _indices = indices !== null && indices !== void 0 ? indices : new Indices();
    __PCLCore__[`removeNaNFromPointCloud${cloudIn._PT.name}`](cloudIn._native, _cloudOut._native, _indices._native);
    return { cloud: _cloudOut, indices: _indices };
}
function removeNaNNormalsFromPointCloud(cloudIn, cloudOut, indices) {
    const _cloudOut = cloudOut !== null && cloudOut !== void 0 ? cloudOut : new PointCloud(cloudIn._PT);
    const _indices = indices !== null && indices !== void 0 ? indices : new Indices();
    __PCLCore__[`removeNaNNormalsFromPointCloud${cloudIn._PT.name}`](cloudIn._native, _cloudOut._native, _indices._native);
    return { cloud: _cloudOut, indices: _indices };
}

class Keypoint extends PCLBase {
...
class ISSKeypoint3D extends Keypoint {
    constructor(_PT = PointXYZ, salientRadius = 0.0001) {
        super(new __PCLCore__[`ISSKeypoint3D${_PT.name}`](salientRadius));
    }
    setSalientRadius(salientRadius) {
        this._native.setSalientRadius(salientRadius);
    }
    setNonMaxRadius(radius) {
    ...
    setThreshold21(gamma21) {
        this._native.setThreshold21(gamma21);
    }
    setThreshold32(gamma32) {
        this._native.setThreshold32(gamma32);
    }
    setAngleThreshold(angle) {
        this._native.setAngleThreshold(angle);
    }
}

class MinCutSegmentation extends PCLBase {
    constructor(PT = PointXYZ) {
    ...
    getColoredCloud() {
        return wrapPointCloud(this._native.getColoredCloud());
    }
}

class SACSegmentation extends PCLBase {
    constructor(random = false) {
        const native = new __PCLCore__.SACSegmentationPointXYZ(random);
        super(native);
        this._modelType = -1;
        this._methodType = 0;
        this._optimizeCoefficients = true;
        this._epsAngle = 0;
        this._threshold = 0;
        this._maxIterations = 50;
        this._probability = 0.99;
        this._samplesRadius = 0;
        this._minRadius = Number.MIN_VALUE;
        this._maxRadius = Number.MAX_VALUE;
    }
    setModelType(model) {
    ...
    setSamplesMaxDist(radius, search) {
    ...
    setOptimizeCoefficients(optimizeCoefficients) {
    ...
    segment(inliers, modelCoefficients) {
...
class Registration extends PCLBase {
    constructor(native) {
        super(native);
    }
    /**
    ...
    getInputSource() {
        return wrapPointCloud(this._native.getInputSource());
    }
    /**
     * Only supports `PointXYZ` type,
     * if it is not `PointXYZ` type, it will use `toXYZPointCloud` method to convert to `PointXYZ`
    ...
    getInputTarget() {
        return wrapPointCloud(this._native.getInputTarget());
    }
    getFitnessScore(maxRange = Number.MAX_VALUE) {
    ...
    setMaxCorrespondenceDistance(distanceThreshold) {
    ...
    setEuclideanFitnessEpsilon(epsilon) {
...
class IterativeClosestPoint extends Registration {
    constructor() {
        const native = new __PCLCore__.IterativeClosestPointPointXYZPointXYZ();
        super(native);
    }
    setUseReciprocalCorrespondences(useReciprocalCorrespondence) {
...
class SampleConsensusInitialAlignment extends Registration {
    constructor() {
        const native = new __PCLCore__.SampleConsensusInitialAlignmentPointXYZPointXYZFPFHSignature33();
        super(native);
    }
    setSourceFeatures(cloud) {
        this._native.setSourceFeatures(cloud._native);
    }
    getSourceFeatures() {
        return wrapPointCloud(this._native.getSourceFeatures());
    }
    setTargetFeatures(cloud) {
        this._native.setTargetFeatures(cloud._native);
    }
    getTargetFeatures() {
        return wrapPointCloud(this._native.getTargetFeatures());
    }
    setMinSampleDistance(minSampleDistance) {
...
class Feature extends PCLBase {
    constructor(native) {
        super(native);
    }
    setSearchSurface(cloud) {
...
class NormalEstimation extends Feature {
    constructor() {
...
class FeatureFromNormals extends Feature {
    constructor(native) {
        super(native);
    }
...
class FPFHEstimation extends FeatureFromNormals {
    constructor() {
    ...
    setNrSubdivisions(nrBinsF1, nrBinsF2, nrBinsF3) {
...
if ((ENVIRONMENT_IS_NODE ? global : window).__PCLCore__) {
    console.warn('Multiple instances of pcl.js being imported.');
}
else {
    (ENVIRONMENT_IS_NODE ? global : window).__PCLCore__ = null;
}
...
function init(options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const { arrayBuffer, url, fetchOptions: fetchSettings = { credentials: 'same-origin' }, } = options !== null && options !== void 0 ? options : {};
        const moduleOptions = {
        ...
        try {
            window.__PCLCore__ = yield PCLCore(moduleOptions);
            isInitialized = true;
...
export { ApproximateVoxelGrid, FPFHEstimation, FPFHSignature33, GridMinimum, ISSKeypoint3D, Indices, InterestPoint, IterativeClosestPoint, KdTreeFLANN, LocalMaximum, MinCutSegmentation, ModelCoefficients, Normal, NormalEstimation, PCLHeader, PCL_VERSION, PassThrough, PointCloud, PointIndices, PointNormal, PointSurfel, PointXY, PointXYZ, PointXYZI, PointXYZINormal, PointXYZL, PointXYZLNormal, PointXYZRGB, PointXYZRGBA, PointXYZRGBL, PointXYZRGBNormal, Points, RadiusOutlierRemoval, RandomSample, SACSegmentation, SacMethodTypes, SacModelTypes, SampleConsensusInitialAlignment, KdTree as SearchKdTree, StatisticalOutlierRemoval, UniformSampling, VERSION, VoxelGrid, computeCloudResolution, destroy, index as fs, init, isInitialized, loadPCDData, loadPCDFile, pointTypeMap, readPCDFileHeader, readPCDHeader, removeNaNFromPointCloud, removeNaNNormalsFromPointCloud, savePCDData, savePCDDataASCII, savePCDDataBinary, savePCDDataBinaryCompressed, savePCDFile, savePCDFileASCII, savePCDFileBinary, savePCDFileBinaryCompressed, toXYZPointCloud };
