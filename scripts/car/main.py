...
def open_new_window():  
    ...
    new_window.geometry("640x430+1280+10")  
...
# 添加按钮
start_record_button = tk.Button(root, text="録画開始", command=start_recording)
start_record_button.grid(row=1, column=0, padx=10, pady=10)
stop_record_button = tk.Button(root, text="録画停止", command=stop_recording)
stop_record_button.grid(row=1, column=1, padx=10, pady=10)
screenshot_button = tk.Button(root, text="スナップ写真", command=capture_screenshot)
...
goto_prest1_button = tk.Button(root, text="ポイント 1", command=lambda: goto_preset(1), width=7)
goto_prest1_button.grid(row=6, column=0, padx=3, pady=5)
goto_prest2_button = tk.Button(root, text="ポイント 2", command=lambda: goto_preset(2), width=7)
goto_prest2_button.grid(row=6, column=1, padx=3, pady=5)
goto_prest3_button = tk.Button(root, text="ポイント 3", command=lambda: goto_preset(3), width=7)
goto_prest3_button.grid(row=6, column=2, padx=3, pady=5)
set_prest1_button = tk.Button(root, text="ポイント1設定", command=lambda: set_preset(1), width=7)
set_prest1_button.grid(row=7, column=0, padx=3, pady=5)
set_prest2_button = tk.Button(root, text="ポイント2設定", command=lambda: set_preset(2), width=7)
set_prest2_button.grid(row=7, column=1, padx=3, pady=5)
set_prest3_button = tk.Button(root, text="ポイント3設定", command=lambda: set_preset(3), width=7)
